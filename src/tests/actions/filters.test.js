...
test(
    'should generate set text filter action object with provided value',
    () => {
        const action = setTextFilter('My filter');
...
test(
    'should generate set text filter action object with default value',
    () => {
